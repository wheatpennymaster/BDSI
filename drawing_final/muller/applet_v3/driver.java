...
public class driver
{
	...
	static void print_specific(double[]generations, String[]genes, double[][]freq)
	{
		...
		{
			System.out.print("Population\t" + genes[i] + "\t");
	...
	public static void main(String[] args) throws IOException
	{
		new GUI();
		/*
		String[]aa = {"BYS2-D06","RMS1-H08","BYS1-A04","BYS2-C06","BYS1-A08","BYB2-F07","BYS2-E01","BYS2-C03","RMS1-G02","RMS1-E09"};
		int []a = {3			,3			,4			,6			,3			,2			,2			,4			,4			,6};
		//for(int i=0;i<aa.length;i++)
		{
			...
			Hierarchical_c k = new Hierarchical_c(a[9], freq, genes);
