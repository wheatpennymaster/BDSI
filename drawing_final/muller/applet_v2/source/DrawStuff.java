...
public class DrawStuff extends JComponent
{
	...
	public void paint(Graphics g)
	{
		...
		*/
		...
		graph2.drawLine(0, 276, (int)(gen[gen.length-1]), 276);
		graph2.drawLine((int)(gen[gen.length-1]),276,(int)(gen[gen.length-1]),0);
		graph2.drawLine((int)(gen[gen.length-1]),0,0,0);
