...
public class DrawStuff extends JComponent
{
	Determiner d;
	double[]gen;
	Color[] colors = {Color.ORANGE, Color.PINK, Color.RED, Color.BLUE, Color.CYAN, Color.GREEN, Color.MAGENTA, Color.YELLOW};
	...
	public void paint(Graphics g)
	{
		...
		*/
		...
		{
			System.out.println(s[i].bottom.getX1());
			System.out.println(s[i].top.getX1());
			System.out.println();
			if(s[i].fix)
			{
